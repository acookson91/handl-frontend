module.exports = function(config){
  config.set({
    ...
    files : [
      ...
      'handl/bower_components/angular-ui-router/release/angular-ui-router.js',
      ...
      'handl/bower_components/angular-cookie/angular-cookie.js',
      'handl/bower_components/angular-cookies/angular-cookies.js',
      'handl/bower_components/ng-token-auth/dist/ng-token-auth.js',
      'handl/js/handl.js',
      'handl/js/**/*.js',
      'test/unit/*.js',
    ],
